...
CREATE TABLE CLASE_SECCION
(
    ID_CLASE_GESTION INT(3),
    NOMBRE VARCHAR(100)
);
ALTER TABLE CLASE_SECCION ADD CONSTRAINT PK_CS PRIMARY KEY(ID_CLASE_GESTION);
ALTER TABLE CLASE_SECCION MODIFY COLUMN ID_CLASE_GESTION INT(3) AUTO_INCREMENT;
